...
// from https://solidity-by-example.org/app/multi-delegatecall/
...
contract TestMultiDelegatecall is MultiDelegatecall {
    ...
    // use call  multiDelegatecall function by msg.value = 1 ETH but put data to call mint() three time in one transaction
    // final balance is 3 ETH instread of 1 ETH
